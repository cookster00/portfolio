...
const steps = [
	{
		...
		title: "Let's Chat",
		description:
			"We'll have a friendly conversation about your business, goals, and what you need from your website.",
	},
	{
		icon: Palette,
		step: "02",
		title: "Design & Plan",
		description:
			"I'll create a design that reflects your brand and plan out all the features your website needs.",
	},
	{
		icon: Code,
		step: "03",
		title: "Build & Test",
		description:
			"I'll build your website, making sure it works perfectly on all devices and loads quickly.",
	},
	{
		icon: Rocket,
		step: "04",
		...
		description:
			"Your website goes live! I'll help you get started and provide ongoing support when you need it.",
	},
]
			...
			<div className="max-w-6xl mx-auto">
				<div className="text-center mb-12">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						...
						Here&apos;s my simple, straightforward process.
					</p>
				</div>
